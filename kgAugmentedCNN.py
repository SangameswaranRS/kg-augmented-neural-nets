...
kt_test_data = pickle.load(open('test_data_kt.pickle', 'rb'))
...
sequences = tokenizer.texts_to_sequences(kt_test_data)
...
kt_target_data = pickle.load(open('target_data_kt.pickle','rb'))
print('[INFO] Test data Prepared')
...
model.summary()
eval_params = model.evaluate(padded_sequences, np.array(kt_target_data))
print('Loss')
print(eval_params[0])
